    ...
    def trader_node(state, name):
        ...
        if portfolio_block:
            user_content += (
                ...
                "(ratio-invariant). Honour the position role: anchors absorb "
                "cycles in full and require a thesis change before SELL; "
                "speculative names tolerate large drawdowns and only exit on "
                "thesis break; tactical names use trailing-stop discipline on "
                "extended winners. Consider: (a) sizing the action relative "
